public class BST<T extends Comparable<T>> extends BT<T> {
    ...
    public void insert(T newData) {
        ...
        if (root == null) {
            ...
            // insert your code
            while (current != null) {
                if ((Double.valueOf(newData.toString()) - Double.valueOf(current.element.toString())) <= 0) {
                    parent = current;
                    current = current.left;
                } else if ((Double.valueOf(newData.toString()) - Double.valueOf(current.element.toString())) > 0) {
                    parent = current;
                    current = current.right;
                }
            }
            if ((Double.valueOf(newData.toString()) - Double.valueOf(parent.element.toString())) < 0) {
    ...
    public T delete(T item) {
        ...
        while (current != null) {
            // insert your code
            if ((Double.valueOf(item.toString()) - Double.valueOf(current.element.toString())) < 0) {
                parent = current;
                current = current.left;
                currentIsLeftChild = true;
            } else if ((Double.valueOf(item.toString()) - Double.valueOf(current.element.toString())) > 0) {
                parent = current;
                current = current.right;
    ...
    public boolean search(T data) {
        ...
        BTNode<T> current = root;
        while (current != null) {
            if ((Double.valueOf(data.toString()) - Double.valueOf(current.element.toString())) < 0) {
                current = current.left;
            } else if ((Double.valueOf(data.toString()) - Double.valueOf(current.element.toString())) > 0) {
                current = current.right;
            } else {
                return true;
            }
